...
row0  <- a[1, ]                                            # 1st row, length 3
col1  <- a[, 2]                                            # 2nd column
y     <- a %*% x                                           # matrix-vector multiply
at    <- t(a)                                              # transpose
sl    <- a[, 2:3]                                          # all rows, cols 2..3
```
