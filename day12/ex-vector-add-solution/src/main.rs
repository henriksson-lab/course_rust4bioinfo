//! Day 12 — Exercise 1: vector add. Reference solution.
...
pub async fn vector_add(a: &[f32], b: &[f32]) -> Vec<f32> {
    ...
    // 2. Buffers — inputs uploaded, output and read-back allocated.
    ...
    // 5. Encode the compute pass + the read-back copy.
    ...
    // 6. Map the read-back buffer and copy out.
