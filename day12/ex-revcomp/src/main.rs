//! Day 12 — Exercise 4: reverse complement on the GPU. Your job: fill in the TODOs marked below.
...
fn complement(b: u32) -> u32 {
    // TODO: map A<->T and C<->G; pass everything else through.
    // ASCII: A=0x41, C=0x43, G=0x47, T=0x54.
    // See hint 1 in 04-revcomp.qmd.
    return b;        // placeholder — replace with the real switch
}
