...
impl GenomicInterval {
    /// Length in base pairs. Coordinates are half-open: end - start.
    fn length(&self) -> u64 {
        // TODO
        0
    }

    /// True iff the two intervals are on the same chromosome and their
    /// half-open ranges overlap (touching but not crossing is NOT overlap).
