...
## The anatomy of a Rust test {.smaller}
...
## What `--release` actually changes {.smaller}
...
## The compiler refuses the dangerous version {.smaller}
...
## Three other rayon tools worth knowing {.smaller}
